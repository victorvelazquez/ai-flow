...
Read **Phase 5: Code Standards** from `.ai-bootstrap/prompts/backend.md` and execute the questionnaire, regardless of the AI tool.

**Time Estimate:** 15-20 minutes

**Phase Objective:** Establish code quality rules, naming conventions, and development practices.
