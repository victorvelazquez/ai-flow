...
Detect changes in the codebase compared to the last documented state (stored in `cache/docs-analysis.json`) and update all affected documentation files automatically.
---
## Execution Flow
