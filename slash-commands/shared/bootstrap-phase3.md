...
Read **Phase 3: System Architecture** from `.ai-bootstrap/prompts/backend/phase-3-system-architecture.md` and execute the questionnaire, regardless of the AI tool.
