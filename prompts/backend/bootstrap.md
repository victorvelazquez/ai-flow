...
1. **Phase 0 (Optional - Existing Projects Only):** Read `.ai-flow/prompts/backend/bootstrap-phase0-context.md`
2. **Phase 1 (Discovery & Business):** Read `.ai-flow/prompts/backend/bootstrap-phase1-business.md`
3. **Phase 2 (Data Architecture):** Read `.ai-flow/prompts/backend/bootstrap-phase2-data.md`
4. **Phase 3 (System Architecture):** Read `.ai-flow/prompts/backend/bootstrap-phase3-architecture.md`
5. **Phase 4 (Security & Authentication):** Read `.ai-flow/prompts/backend/bootstrap-phase4-security.md`
6. **Phase 5 (Code Standards):** Read `.ai-flow/prompts/backend/bootstrap-phase5-standards.md`
7. **Phase 6 (Testing Strategy):** Read `.ai-flow/prompts/backend/bootstrap-phase6-testing.md`
8. **Phase 7 (Operations & Deployment):** Read `.ai-flow/prompts/backend/bootstrap-phase7-operations.md`
...
```
Read .ai-flow/prompts/backend/bootstrap-phase4-security.md and execute only Phase 4
```
...
```
Read .ai-flow/prompts/backend/bootstrap-phase1-business.md and execute Phase 1
```
...
```
Read .ai-flow/prompts/backend/bootstrap-phase0-context.md and execute Phase 0
```
...
**For detailed instructions:** Read `.ai-flow/prompts/backend/docs-update.md`
...
- **Maintaining Docs:** Use `/docs-update` command (see AI Flow README for details)
...
Generated by AI Flow /bootstrap command:
